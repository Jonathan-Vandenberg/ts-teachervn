...
const AccomodationDetailsPage: NextPage<AccProps> = (props): ReactJSXElement => {
...
export const getStaticPaths: GetStaticPaths = async () => {
  ...
  const client: mongoDB.MongoClient = await MongoClient.connect(`${process.env.ACCOMODATION_KEY}`)
